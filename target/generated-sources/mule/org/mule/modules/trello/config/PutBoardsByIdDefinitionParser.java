    ...
    extends AbstractDevkitBasedDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        if (hasAttribute(element, "boardsByIdPutReq-ref")) {
            if (element.getAttribute("boardsByIdPutReq-ref").startsWith("#")) {
                builder.addPropertyValue("boardsByIdPutReq", element.getAttribute("boardsByIdPutReq-ref"));
            } else {
                builder.addPropertyValue("boardsByIdPutReq", (("#[registry:"+ element.getAttribute("boardsByIdPutReq-ref"))+"]"));
            }
        }
