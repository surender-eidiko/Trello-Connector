    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
     ...
     * @param value Value to set
     */
    public void setSavedSearchId(Object value) {
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TrelloConnector at getSavedSearchesBySavedSearchId retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
