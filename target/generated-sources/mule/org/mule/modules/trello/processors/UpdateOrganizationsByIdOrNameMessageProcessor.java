...
/**
 * UpdateOrganizationsByIdOrNameMessageProcessor invokes the {@link org.mule.modules.trello.TrelloConnector#updateOrganizationsByIdOrName(java.lang.String, org.mule.modules.trello.bean.OrganizationPutRequest)} method in {@link TrelloConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public UpdateOrganizationsByIdOrNameMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    /**
     * Sets organizationPutReq
     * 
     * @param value Value to set
     */
    public void setOrganizationPutReq(Object value) {
        this.organizationPutReq = value;
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TrelloConnector) object).updateOrganizationsByIdOrName(_transformedOrganizationId, _transformedOrganizationPutReq);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TrelloConnector at updateOrganizationsByIdOrName retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
