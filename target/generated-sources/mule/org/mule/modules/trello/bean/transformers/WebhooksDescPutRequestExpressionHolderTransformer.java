...
public class WebhooksDescPutRequestExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == WebhooksDescPutRequestExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == WebhooksDescPutRequestExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {WebhooksDescPutRequestExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(WebhooksDescPutRequestExpressionHolder.class)});
    }
    ...
    public Class<?> getReturnClass() {
        return WebhooksDescPutRequest.class;
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(WebhooksDescPutRequest.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        WebhooksDescPutRequestExpressionHolder holder = ((WebhooksDescPutRequestExpressionHolder) src);
        WebhooksDescPutRequest result = new WebhooksDescPutRequest();
        try {
            final String _transformedValue = ((String) evaluateAndTransform(this.muleContext, event, WebhooksDescPutRequestExpressionHolder.class.getDeclaredField("_valueType").getGenericType(), null, holder.getValue()));
