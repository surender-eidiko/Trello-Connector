...
public class CardsClosedPutRequestExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == CardsClosedPutRequestExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == CardsClosedPutRequestExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {CardsClosedPutRequestExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(CardsClosedPutRequestExpressionHolder.class)});
    }
    ...
    public Class<?> getReturnClass() {
        return CardsClosedPutRequest.class;
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(CardsClosedPutRequest.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        CardsClosedPutRequestExpressionHolder holder = ((CardsClosedPutRequestExpressionHolder) src);
        CardsClosedPutRequest result = new CardsClosedPutRequest();
        try {
            final Boolean _transformedValue = ((Boolean) evaluateAndTransform(this.muleContext, event, CardsClosedPutRequestExpressionHolder.class.getDeclaredField("_valueType").getGenericType(), null, holder.getValue()));
